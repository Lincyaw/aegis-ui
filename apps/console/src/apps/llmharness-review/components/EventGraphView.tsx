...
interface EventGraphViewProps {
  ...
  /** Optional fixed height; defaults to 480px via CSS. */
  height?: number;
}
...
function colOf(event: ExtractorEvent): number {
  if (event.source_turns.length === 0) {
    return 0;
  }
...
function positionEvents(
  ...
  const byCol = new Map<number, ExtractorEvent[]>();
