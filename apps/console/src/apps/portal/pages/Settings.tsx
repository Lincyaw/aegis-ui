  ...
  return (
    <>
      ...
      >
        ...
        <FormRow
          label='Role'
          description='Determines permissions across the workspace.'
        >
      ...
      <DangerZone description='Once you delete a user, all their associated data will be permanently removed. This action cannot be undone.'>
        <div className='settings-demo-danger-row'>
          <span>Delete this user account</span>
          <button type='button' className='settings-demo-danger-btn'>
            Delete user
          </button>
        </div>
      </DangerZone>
  ...
  return (
    <>
      ...
      >
        ...
        <FormRow
          label='Editor'
          description='Can create and modify experiments, cannot manage users.'
        >
    ...
    <>
      ...
      >
        <FormRow
          ...
          description='Created 2024-03-15 · Last used 2 h ago'
        >
          <MonoValue size='sm'>ak_live_••••••••••••8f2a</MonoValue>
        </FormRow>
        <FormRow
          label='CI/CD Pipeline'
          description='Created 2024-01-20 · Last used 1 d ago'
        >
  ...
  return (
    <>
      ...
      >
        <FormRow
          label='user.created'
          description='2024-05-10 14:32:01 · admin@aegislab.io'
        >
          <MonoValue size='sm'>user:grace-hopper</MonoValue>
        </FormRow>
        <FormRow
          label='project.updated'
          description='2024-05-10 11:15:33 · ada@aegislab.io'
        >
          <MonoValue size='sm'>project:catalog-service</MonoValue>
        </FormRow>
        <FormRow
          label='injection.executed'
          description='2024-05-09 09:42:18 · service-account'
        >
...
export default function Settings() {
  ...
  const activeKey =
    SETTINGS_NAV.find((t) => location.pathname.endsWith(t.key))?.key ?? 'users';
